          ...
          <div className="max-w-5xl mx-auto">
            <Card className="mb-8">
              <CardContent className="p-8 md:p-12">
                ...
                <div className={`grid gap-6 pt-6 border-t ${(id === 'spb-konstantinova-1k1str1' || id === 'spb-petrovskiy-5str1' || id === 'spb-piterskiy-1' || id === 'spb-piterskiy-5' || id === 'spb-piterskiy-7' || id === 'spb-krasnoselskoe-6' || id === 'spb-krasnoselskoe-16' || id === 'spb-belyhNochey-3') ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
                  <Card className="bg-secondary/5">
                    <CardContent className="p-6">
                      <h3 className="font-semibold mb-4 flex items-center gap-2">
