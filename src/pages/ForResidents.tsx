...
const ForResidents = () => {
  const guides = [
    ...
    {
      title: "Отказ от радиоточки",
      icon: "Radio",
      steps: [
        "ООО «ИНФОТЕХ»/ ООО «ОТЛИЧНЫЙ СВЯЗИСТ»",
        "Для отказа от услуг проводного радиовещания необходимо:",
        "1. Лично предоставить в диспетчерский отдел заявление на отказ от услуг по адресу: г. Санкт-Петербург, пр. Энергетиков, д. 3, лит. Б, пом. 3/01 (3 этаж ТЦ «Ладожские ряды»)",
        "Время работы: по рабочим дням с 10:00 до 20:00, суббота с 12:00 до 16:00, воскресенье и праздничные дни - выходной",
        "2. При себе необходимо иметь: документ, удостоверяющий личность, и документ о праве собственности на объект недвижимости",
        "Интересы жильца может представлять другое лицо, имеющее нотариальную доверенность",
        "За информацией обращаться по телефону: (812) 640-88-40",
      ],
    },
  ];
