...
const Index = () => {
  ...
  const houses = [
    { id: 1, name: "ЖК Золотое Сечение", address: "ул. Васенко, д. 12 лит. А", x: 45, y: 35 },
    { id: 2, name: "ЖК Панорама", address: "пр. Кондратьевский, д. 62, корп. 1", x: 42, y: 28 },
    { id: 3, name: "ЖК Панорама", address: "пр. Кондратьевский, д. 62, корп. 2", x: 44, y: 30 },
    { id: 4, name: "ЖК Панорама", address: "пр. Кондратьевский, д. 66, корп. 1", x: 46, y: 32 },
    { id: 5, name: "ЖК Полюстрово", address: "пр. Металлистов, д. 116, корп. 1", x: 50, y: 25 },
    { id: 6, name: "ЖК Полюстрово", address: "Фермское шоссе, д. 22, корп. 3", x: 52, y: 27 },
    { id: 7, name: "Кудрово", address: "Европейский пр., д. 4, корп. 2", x: 85, y: 35 },
    { id: 8, name: "Кудрово", address: "Европейский пр., д. 6, корп. 2", x: 87, y: 37 },
    { id: 9, name: "Кудрово", address: "Европейский пр., д. 8, корп. 2", x: 89, y: 39 },
    { id: 10, name: "ЖК Остров", address: "Полюстровский пр., д. 59", x: 48, y: 40 },
  ];
