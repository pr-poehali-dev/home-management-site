        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold">Наша цель</h2>
              <p className="text-lg text-muted-foreground">
                Мы – команда профессионалов, использующая передовые технологии для эффективного управления многоквартирными домами.
              </p>
              <p className="text-lg text-muted-foreground">
                Наша цель – предоставлять высококачественные услуги, обеспечивающие комфорт, безопасность и процветание Вашего жилья. Мы стремимся к безупречности в каждой детали, чтобы сделать Вашу жизнь проще и приятнее.
              </p>
            </div>
          </div>
