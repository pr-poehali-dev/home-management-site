    ...
    script.onload = () => {
      window.ymaps.ready(() => {
        ...
        const addressCoords: {[key: string]: [number, number]} = {
          ...
          "Красносельское шоссе, д. 6": [59.8095, 30.0685],
          "Красносельское шоссе, д. 16": [59.8105, 30.0695],
          "ул. Адмиралтейская, д. 1": [59.8125, 30.0755],
          "ул. Адмиралтейская, д. 3": [59.8128, 30.0758],
          "ул. Адмиралтейская, д. 9": [59.8135, 30.0765],
          "ул. Адмиралтейская, д. 11": [59.8138, 30.0768],
          "ул. Большая Зеленина, д. 24 стр. 1 + паркинг": [59.9620, 30.3080],
          "пр. Питерский, д. 1": [59.8065, 30.0725],
          "пр. Питерский, д. 5": [59.8068, 30.0728],
          "пр. Питерский, д. 7": [59.8070, 30.0730],
          "ул. Невская, д. 1": [59.8145, 30.0775],
          "ул. Невская, д. 3": [59.8148, 30.0778],
          "ул. Невская, д. 4": [59.8150, 30.0780],
          "ул. Невская, д. 5/7": [59.8153, 30.0783],
          "ул. Невская, д. 6": [59.8155, 30.0785],
          "ул. Невская, д. 10/5": [59.8160, 30.0790],
          ...
          "бульвар Белых Ночей, д. 3": [59.8115, 30.0745],
          ...
          "пр. Строителей, д. 6 + паркинг": [59.9185, 30.5275],
          ...
          "Каштановая аллея, д. 2": [59.9125, 30.5125],
          "Каштановая аллея, д. 3": [59.9128, 30.5128],
          "ул. Областная, д. 9, корп. 1": [59.9135, 30.5235],
          "ул. Областная, д. 9, корп. 2": [59.9138, 30.5238],
          "пр. Петровский, д. 5 стр. 1 (+паркинг)": [60.0695, 30.3905],
          "Приморское шоссе, д. 352 стр. 1 (ЖК «Пляж») + паркинг": [60.0305, 30.2145],
          "ул. Академика Константинова, д. 1 корп. 1 стр. 1": [60.0115, 30.3845],
          "ул. Большая Зеленина, д. 24 стр. 1": [59.9620, 30.3080]
        };
