...
const LOGO_URL = "https://cdn.poehali.dev/projects/fe9589b6-f411-4b39-b21e-3be97169a177/bucket/a6b8e2b9-2e99-4be8-8e09-47c9fefe9f00.jpg";
...
const Layout = ({ children }: LayoutProps) => {
  ...
  const warningText = "УВАЖАЕМЫЕ СОБСТВЕННИКИ!  НАПОМИНАЕМ, ЧТО С 01.07.2026 г. УВЕЛИЧИВАЕТСЯ РАЗМЕР ТАРИФА ЗА ЖИЛИЩНЫЕ УСЛУГИ, ПРЕДУСМОТРЕННОГО ДОГОВОРОМ УПРАВЛЕНИЯ МНОГОКВАРТИРНЫМ ДОМОМ, ЗАКЛЮЧЕННЫМ МЕЖДУ СОБСТВЕННИКАМИ ПОМЕЩЕНИЙ И УПРАВЛЯЮЩЕЙ ОРГАНИЗАЦИЕЙ.     ";
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-red-600 text-white overflow-hidden whitespace-nowrap sticky top-[var(--header-h,0)] z-40" style={{ height: '44px' }}>
        <style>{`
          @keyframes marquee {
